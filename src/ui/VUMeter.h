...
public:
    ...
    void paint(juce::Graphics& g) override
    {
        ...
        for (int i = 0; i < N; ++i)
        {
            ...
            juce::uint32 col;
            if (frac > 0.86f)      col = lit ? TommyLookAndFeel::cMeterHigh    : TommyLookAndFeel::cMeterHighDim;
            else if (frac > 0.65f) col = lit ? TommyLookAndFeel::cMeterMid     : TommyLookAndFeel::cMeterMidDim;
            else                   col = lit ? TommyLookAndFeel::cMeterLow     : TommyLookAndFeel::cMeterLowDim;
